        ...
        for cell_id_type in cell_id_type_list:
            ...
            for selected_filename in selected_filename_list:
                ...
                for selected_unique_consec_group in selected_unique_consec_group_list:
                    ...
                    negative_frame_set = merged_df.groupby(cell_type_id_columns[0]).apply(filter_and_label).reset_index(drop=True)
...
if __name__ == "__main__":
    ...
    existing_velocity_t_cell_data_path = '/gladstone/engelhardt/lab/adamw/Occident-Paper-Cluster/Figure_4/analysis/cell_tracking_t_cell_csv_data_2025-05-09_09:18:42'
    existing_velocity_cancer_cell_data_path = '/gladstone/engelhardt/lab/adamw/Occident-Paper-Cluster/Figure_4/analysis/cell_tracking_cancer_csv_data_2025-05-09_09:18:42'
